 ...
 * Generated at: 2020-02-18 00:45:19 UTC
...
public final class profile2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<style>\r\n");
      out.write("\t.box_con{left:20px; width:800px; height:200px; background-color:#fcc6c9; position:absolute;}\r\n");
      out.write("\t.box{width: 150px; height:150px; border-radius:70%; overflow:hidden; background-color:#fff;margin-top:25px;margin-left:280px;}\r\n");
      out.write("\t.profile{width: 100%; height:100%; object-fit:cover; display:block; margin:0px auto;}\r\n");
      out.write("\t.userTitle{font-size:40px; text-align:left; top:30px;}\r\n");
      ...
      out.write("\t.delete{line-height: 30px; text-align: center; background-color: #ffe3e4; color:#ff4e59;border: 1px solid #fcc6c9; border-radius: 5px; width: 80px; height: 35px; position: absolute;left:50%;top:20px; outline:none;margin-left:100px;}\r\n");
      out.write("\t.boxBody{position:absolute; top:250px;margin-left:20px;}\r\n");
      out.write("\t.submitBody{position:absolute; top:850px; margin-left:20px;}\r\n");
      out.write("\t.choice_pet{top:400px; font-size: 10pt; width: 100px; padding: .7em .5em; font-family: inherit; background: url(https://farm1.staticflickr.com/379/19928272501_4ef877c265_t.jpg) no-repeat 95% 50%; -webkit-appearance: none; -moz-appearance: none; appearance: none; outline:none; border:1px solid #5d5d5d;}\r\n");
      out.write("</style>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t");
      ...
      out.write("\t    \t\t</div>\r\n");
      out.write("    \t\t</div>\r\n");
      out.write("    \t\t<div class=\"choice_pet\">\r\n");
      out.write("    \t\t\t<select>\r\n");
      out.write("    \t\t\t\t<option>너의 반려동물</option>\r\n");
      out.write("    \t\t\t\t<option>고른다</option>\r\n");
      out.write("    \t\t\t</select>\r\n");
      out.write("    \t\t</div>\r\n");
      out.write("\t\t    <div class=\"boxBody\">\t\r\n");
      out.write("\t\t\t\t<div class=\"input-box\">\r\n");
      out.write("\t\t\t\t\t<p class=\"input-label\">반려동물 이름</p><input type=\"text\">\r\n");
      out.write("\t    \t\t\t<p class=\"input-label\">품종</p><input type=\"text\">\r\n");
      out.write("\t    \t\t\t<p class=\"input-label\">성별</p><input type=\"text\">\r\n");
      out.write("\t    \t\t\t<p class=\"input-label\">생년월일</p><input type=\"text\">\r\n");
      out.write("\t    \t\t\t<p class=\"input-label\">중성화 여부</p><input type=\"email\">\r\n");
      out.write("\t    \t\t\t<p class=\"input-label\">기초 예방 접종 여부</p><input type=\"text\">\r\n");
      out.write("\t    \t\t\t<p class=\"input-label\">체중</p><input type=\"text\">\r\n");
      out.write("\t    \t\t</div>\r\n");
      out.write("\t    \t</div>\r\n");
      out.write("    \t</div>\r\n");
      out.write("    \t\r\n");

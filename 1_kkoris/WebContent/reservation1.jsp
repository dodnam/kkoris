...
<style>
    ...
    .search_box1{line-height: 30px; text-align: center; background-color: #ffe3e4; color:#ff4e59;border: 1px solid #fcc6c9; border-radius: 5px; width: 80px; height: 35px;  position: fixed;right: 30px; top: 25px; outline:none;}
  	.search_box2{line-height: 30px; text-align: center; background-color: #ffe3e4; color:#ff4e59;border: 1px solid #fcc6c9; border-radius: 5px; width: 80px; height: 35px;  margin-left: 150px; margin-top:20px; outline:none;}

   	.city-sel{margin-top:100px; margin-left:30px;}
   	.animal-sel{margin-top:30px;margin-left:30px;}
   	.medi-sel{margin-top:30px; margin-left:30px;}
   	...
   	#map{width:300px; height:250px; top:350px; margin-left:30px; position:absolute;}
...
<body onload = "init(this.form);">
	...
	<div class="container">
		...
		<div class="medi-sel">
			<div class="select-box">
				<select>
					<option value="" disabled>건강검진</option>
					<option>기초 종합검진</option>
					<option>복합 종합검진</option>
					<option value="" disabled>혈액검사</option>
					<option>기초 혈액검사</option>
					<option value="" disabled>안과검진</option>
					<option>안과검진</option>
					<option value="" disabled>예방접종</option>
					<option>코로나</option>
					<option>켄넬로프</option>
					<option>반려견 종합백신</option>
					<option>광견병</option>
					<option>인플루엔자</option>
					<option>반려묘 종합백신</option>
					<option>항체가검사</option>
					<option value="" disabled>치과</option>
					<option>스케일링</option>
					<option>발치</option>
					<option value="" disabled>피부과</option>
					<option>곰팡이균 검사</option>
					<option>알러지 검사</option>
					<option value="" disabled>키트검사</option>
					<option>심장사상충 검사</option>
					<option>혈액형 검사</option>
					<option value="" disabled>내시경</option>
					<option>내시경</option>
					<option value="" disabled>초음파</option>
					<option>초음파</option>
					<option value="" disabled>중성화 수술</option>
					<option>수컷</option>
					<option>암컷</option>
					<option>잠복고환</option>
					<option>기타</option>
